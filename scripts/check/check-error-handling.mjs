 ...
 *      why all five of them already do. This is the rule that keeps the sixth
 ...
 *      to quit, and to the next launch as a lock already taken. Slate holds
 ...
 *      drop. Every one of the three swallows in this codebase answers it
 ...
 * Empty: Slate's main process opens a dialog, reads or writes one .slate file
 * and returns — nothing survives the call. Add a service here the day one owns
